...
GO
PRINT N'Creating Table [dbo].[Jokes]...';
...
GO
PRINT N'Creating Table [dbo].[JokesCategories]...';
...
ALTER TABLE [dbo].[Categories]
    ADD DEFAULT 0 FOR [IsAdult];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Jokes]...';
...
GO
ALTER TABLE [dbo].[JokesCategories]
    ADD CONSTRAINT [FK_JokesCategories_ToJokes] FOREIGN KEY ([IdJoke]) REFERENCES [dbo].[Jokes] ([Id]);


GO
PRINT N'Creating Foreign Key [dbo].[FK_JokesCategories_ToCategories]...';


GO
ALTER TABLE [dbo].[JokesCategories]
    ADD CONSTRAINT [FK_JokesCategories_ToCategories] FOREIGN KEY ([IdCategory]) REFERENCES [dbo].[Categories] ([Id]);


GO
PRINT N'Creating View [dbo].[VuSersBlagues]...';
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '081c3c83-86c3-4da6-9b2f-8b0d56a03463')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('081c3c83-86c3-4da6-9b2f-8b0d56a03463')
